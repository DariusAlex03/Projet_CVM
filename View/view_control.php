...
<main class="mx-auto" style="width: 182vh; margin-top: 50px; border: solid 1px lightgray; border-radius: 10px">
    <table class="table">
        ...
        <tr>
            ...
            <td><?= e($val['date']);?></td>
            <td>
                <button type="button" data-bs-toogle="modal" data-bs-target="#modal">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25"  fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">

...
<section class="mx-auto" style="margin-top: 5vh">
    <div >
        <h1 style="text-align: center;margin-bottom: 0px;">Connexion au tableau de bord</h1>
        <form action="" method="post" style="text-align: center; margin-top: 8vh">
            <label style="font-size: 30px;">Identifiant :</label>
            <br>
            <input name="identifiant" type="text" style="width: 350px;height: 40px;border-radius: 10px;padding: 0 10px 0 20px;font-size: 20px;">
            <br>
            ...
            <span style="font-size: 15px;">Pas encore de compte ? <a href="?controller=identification&action=creation">Créer un compte</a></span>
        </form>
    </div>
</section>
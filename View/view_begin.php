...
<body style="background-color: aliceblue">
    <header>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary mx-auto " style="height: 50px; width: 180vh; border: solid 1px lightgrey; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; background-color: white">
            <div class="container-fluid">
                <a class="navbar-brand">CVM RENOVATION</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active" aria-current="page" href="#notre-entreprise">Notre entreprise</a>
                        <a class="nav-link" href="#nos-services">Nos Services</a>
                        <a class="nav-link" href="#nos-modeles">Nos modèles</a>
                        <a class="nav-link" href="#demande-devis">Demander un devis</a>
                    </div>
                </div>
            </div>
        </nav>
